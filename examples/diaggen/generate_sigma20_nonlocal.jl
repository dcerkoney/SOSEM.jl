...
settings = DiagGen.Settings{DiagGen.Observable}(; DiagGen.sigma20,max_order=4, verbosity=DiagGen.info)

# Build diagram and expression trees for all sigma_2 diagrams at order n
diagparam, sigma20, sigma20_compiled = DiagGen.build_sigma2_nonlocal(settings)
