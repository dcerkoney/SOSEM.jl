...
function partition(order::Int)
    ...
    # NOTE: partitions of the form (0, nμ, nλ) with nλ > 0 vanish,
    ...
    partitions = [
        ...
        #order 3
        (3, 0, 0), (2, 1, 0), (2, 0, 1),
        (1, 1, 1), (1, 2, 0), (1, 0, 2), (0, 3, 0),
        #order 4
        (4, 0, 0), (3, 1, 0), (3, 0, 1), (2, 1, 1), (2, 2, 0),
        (2, 0, 2), (1, 3, 0), (1, 0, 3), (1, 2, 1), (1, 1, 2), (0, 4, 0),
        #order 5
        ...
        (1, 4, 1), (1, 3, 2), (1, 2, 3), (1, 1, 4), (1, 0, 5), (0, 6, 0),
    ]
    #! format: on
...
function counterterm_partitions(
    ...
    return [
        p for p in counterterm_partitions(
            n_min,
            n_max;
            n_lowest,
            renorm_mu=renorm_mu,
